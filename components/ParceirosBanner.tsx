      ...
      <div className="marquee-track">
        {[...PARCEIROS, ...PARCEIROS].map((item, idx) => (
          <a
            ...
            className={`mx-8 flex items-center justify-center rounded-xl px-6 py-3 hover:scale-105 transition-all duration-300 shadow-sm ${item.dark ? 'bg-[#0f172a]' : 'bg-white'}`}
          >
