...
const PARCEIROS = [
  ...
  { name: 'Sistema Ocepar',      logo: 'https://www.paranacooperativo.coop.br/images/Logo/logo-sistemaocepar.svg',                                                                                               url: 'https://www.paranacooperativo.coop.br',     dark: true,  square: false },
