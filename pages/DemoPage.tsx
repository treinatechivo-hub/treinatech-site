          ...
          <div className="bg-slate-800 rounded-3xl overflow-hidden shadow-2xl border border-slate-700">
            ...
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                src="https://treinatechivo-my.sharepoint.com/:v:/g/personal/ivo_treinatech_com_br/IQByBdNBmiCFSIk-t1CTcvD6AQxNbDHRQgoMdOcyXsSdVbI?e=277EYh&action=embedview"
                frameBorder="0"
                allowFullScreen
